...
%warning "A biblioteca de manipulacao de video em modo interface grafica"
%warning "(GUI) 'video.s', que cuida de componentes da interface e do"
%warning "sistema de entrada/saida do modo grafico/texto deve ser"
%warning "importada antes da importacao desta biblioteca de interface."
%warning "Algumas funcoes da biblioteca de interface necessitam de"
%warning "funcoes presentes apenas na biblioteca 'video.s'."

%error "Impossivel iniciar funcoes da biblioteca de interfaces."

%endif

%ifdef MODO_TEXTO

%warning "A biblioteca 'video.s' nao e compativel com a biblioteca"
%warning "de criacao/manipulacao de interfaces graficas 'gui.s'"
%warning "A biblioteca de video 'video.s' e uma bilioteca de manipulacao"
%warning "de video em modo texto, apenas."

%error "Impossivel utilizar biblioteca de modo texto."
